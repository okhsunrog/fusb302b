...
impl<I> Device<I> {
    ...
    pub fn switches_0(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Switches0, ::device_driver::RW>
    {
    ...
    pub fn switches_1(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Switches1, ::device_driver::RW>
    {
    ...
    pub fn measure(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Measure, ::device_driver::RW>
    {
    ...
    pub fn slice(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Slice, ::device_driver::RW> {
        let address = self.base_address + 5;

        ::device_driver::RegisterOperation::<'_, I, u8, field_sets::Slice, ::device_driver::RW>::new(
            self.interface(),
            address as u8,
            field_sets::Slice::new,
        )
    }
    ...
    pub fn control_0(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Control0, ::device_driver::RW>
    {
    ...
    pub fn control_1(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Control1, ::device_driver::RW>
    {
    ...
    pub fn control_2(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Control2, ::device_driver::RW>
    {
    ...
    pub fn control_3(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Control3, ::device_driver::RW>
    {
    ...
    pub fn mask(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Mask, ::device_driver::RW> {
        let address = self.base_address + 10;

        ::device_driver::RegisterOperation::<'_, I, u8, field_sets::Mask, ::device_driver::RW>::new(
            self.interface(),
            address as u8,
            field_sets::Mask::new,
        )
    ...
    pub fn power(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Power, ::device_driver::RW> {
        let address = self.base_address + 11;

        ::device_driver::RegisterOperation::<'_, I, u8, field_sets::Power, ::device_driver::RW>::new(
            self.interface(),
            address as u8,
            field_sets::Power::new,
        )
    }
    ...
    pub fn reset(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Reset, ::device_driver::WO> {
        let address = self.base_address + 12;

        ::device_driver::RegisterOperation::<'_, I, u8, field_sets::Reset, ::device_driver::WO>::new(
            self.interface(),
            address as u8,
            field_sets::Reset::new,
        )
    }
    ...
    pub fn ocpreg(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Ocpreg, ::device_driver::RW>
    {
    ...
    pub fn maska(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Maska, ::device_driver::RW> {
        let address = self.base_address + 14;

        ::device_driver::RegisterOperation::<'_, I, u8, field_sets::Maska, ::device_driver::RW>::new(
            self.interface(),
            address as u8,
            field_sets::Maska::new,
        )
    }
    ...
    pub fn maskb(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Maskb, ::device_driver::RW> {
        let address = self.base_address + 15;

        ::device_driver::RegisterOperation::<'_, I, u8, field_sets::Maskb, ::device_driver::RW>::new(
            self.interface(),
            address as u8,
            field_sets::Maskb::new,
        )
    }
    ...
    pub fn control_4(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Control4, ::device_driver::RW>
    {
    ...
    pub fn status_0_a(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Status0A, ::device_driver::RO>
    {
    ...
    pub fn status_1_a(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Status1A, ::device_driver::RO>
    {
    ...
    pub fn interrupta(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Interrupta, ::device_driver::RW>
    {
    ...
    pub fn interruptb(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Interruptb, ::device_driver::RW>
    {
    ...
    pub fn status_0(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Status0, ::device_driver::RO>
    {
    ...
    pub fn status_1(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Status1, ::device_driver::RO>
    {
    ...
    pub fn interrupt(
        &mut self,
    ) -> ::device_driver::RegisterOperation<'_, I, u8, field_sets::Interrupt, ::device_driver::RW>
    {
    ...
    pub fn fifo(&mut self) -> ::device_driver::BufferOperation<'_, I, u8, ::device_driver::RW> {
...
pub mod field_sets {
    ...
    impl DeviceId {
        ...
        pub fn version_id(&self) -> super::Fusb302Version {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 4, 8)
            };
        ...
        pub fn product_id(&self) -> super::Fusb302Product {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 2, 4)
            };
        ...
        pub fn revision_id(&self) -> super::Fusb302Revision {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 0, 2)
            };
    ...
    impl Switches0 {
        ...
        pub fn meas_cc_2(&self) -> bool {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 3, 4)
            };
        ...
        pub fn meas_cc_1(&self) -> bool {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 2, 3)
            };
        ...
        pub fn pdwn_2(&self) -> bool {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 1, 2)
            };
        ...
        pub fn pdwn_1(&self) -> bool {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 0, 1)
            };
    ...
    impl Switches1 {
        ...
        pub fn specrev(&self) -> Result<super::SpecRev, <super::SpecRev as TryFrom<u8>>::Error> {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 5, 7)
            };
    ...
    impl Measure {
        ...
        pub fn mdac(&self) -> u8 {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 0, 6)
            };
    ...
    impl Slice {
        ...
        pub fn sdac_hys(&self) -> super::SlicerHysteresis {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 6, 8)
            };
    ...
    impl Control2 {
        ...
        pub fn mode(&self) -> Result<super::ToggleMode, <super::ToggleMode as TryFrom<u8>>::Error> {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 1, 3)
            };
    ...
    impl Power {
        ...
        ///Read the `pwr_3_internal_oscillator_enable` field of the register.
        ///
        /// Enable internal oscillator (PWR[3]).

        pub fn pwr_3_internal_oscillator_enable(&self) -> bool {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 3, 4)
            };
        ...
        ///Read the `pwr_2_measure_block_power_enable` field of the register.
        ///
        /// Measure block powered (PWR[2]).

        pub fn pwr_2_measure_block_power_enable(&self) -> bool {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 2, 3)
            };
        ...
        ///Read the `pwr_1_receiver_and_measure_refs_enable` field of the register.
        ///
        /// Receiver powered and current references for Measure block (PWR[1]).

        pub fn pwr_1_receiver_and_measure_refs_enable(&self) -> bool {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 1, 2)
            };
        ...
        ///Read the `pwr_0_bandgap_and_wake_enable` field of the register.
        ///
        /// Bandgap and wake circuit enabled (PWR[0]).

        pub fn pwr_0_bandgap_and_wake_enable(&self) -> bool {
            let raw = unsafe {
                ::device_driver::ops::load_lsb0::<u8, ::device_driver::ops::BE>(&self.bits, 0, 1)
            };
        ...
        ///Write the `pwr_3_internal_oscillator_enable` field of the register.
        ///
        /// Enable internal oscillator (PWR[3]).

        pub fn set_pwr_3_internal_oscillator_enable(&mut self, value: bool) {
            let raw = value as _;
        ...
        ///Write the `pwr_2_measure_block_power_enable` field of the register.
        ///
        /// Measure block powered (PWR[2]).

        pub fn set_pwr_2_measure_block_power_enable(&mut self, value: bool) {
            let raw = value as _;
        ...
        ///Write the `pwr_1_receiver_and_measure_refs_enable` field of the register.
        ///
        /// Receiver powered and current references for Measure block (PWR[1]).

        pub fn set_pwr_1_receiver_and_measure_refs_enable(&mut self, value: bool) {
            let raw = value as _;
        ...
        ///Write the `pwr_0_bandgap_and_wake_enable` field of the register.
        ///
        /// Bandgap and wake circuit enabled (PWR[0]).

        pub fn set_pwr_0_bandgap_and_wake_enable(&mut self, value: bool) {
            let raw = value as _;
    ...
    impl defmt::Format for Power {
        fn format(&self, f: defmt::Formatter) {
            ...
            defmt::write!(
                f,
                "pwr_2_measure_block_power_enable: {=bool}, ",
                &self.pwr_2_measure_block_power_enable()
            );

            defmt::write!(
                f,
                "pwr_1_receiver_and_measure_refs_enable: {=bool}, ",
                &self.pwr_1_receiver_and_measure_refs_enable()
            );
